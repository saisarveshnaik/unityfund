          ...
          <div className='col-md-7 left'>
            {bigBlog && (
              ...
              <div className='big' data-aos="zoom-in">
                ...
                <img src={`https://apigaming.imetatech.io/${bigBlog.blog_image}`} className='big-small' alt="game-img" />
              </div>
              </Link>
            )}
          </div>
          <div className='col-md-5 right'>
            {smallBlogs.map((blog) => (
              <div key={blog.blog_id} className='small' data-aos="zoom-in">
                ...
                <img src={`https://apigaming.imetatech.io/${blog.blog_image}`} className='small-small' alt="game-img" />
                </Link>
              </div>
            ))}
          </div>
